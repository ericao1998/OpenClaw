...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    missionControl: "Workspace-wide coordination, routing, and ownership.",
    overview: "Status, entry points, health.",
    channels: "Channels and settings.",
    instances: "Connected clients and nodes.",
    sessions: "Repo selection for project-scoped orchestration.",
  ...
  missionControl: {
    ...
    subtitle: "Workspace operations shell for tasks, routing, ownership, and live activity.",
    shell: {
      title: "Mission Control",
      subtitle: "Tasks-first operating layer for the workspace.",
      status: "Workspace status",
      header: "Tasks",
      headerSubtitle:
        "Run the workspace from one board, with routing and session controls underneath.",
      newTask: "+ New task",
      tasks: "Tasks",
      agents: "Agents",
      approvals: "Approvals",
      ...
      sectionDetail: {
        tasks: "Open work, review queue, and intervention points.",
        agents: "Lane coverage, active sessions, and operator reachability.",
        approvals: "Human decisions waiting to unblock execution.",
        calendar: "Scheduled work, recurring runs, and time-based commitments.",
        projects: "Major workstreams and where progress is actually happening.",
        memory: "Recent context, daily logs, and long-term recall.",
        docs: "Plans, specs, briefs, and generated working documents.",
        team: "Roles, ownership, and who should carry what.",
        system: "Gateway health, state, and operating constraints.",
      },
      stats: {
        thisWeek: "This week",
    ...
    summary: {
      ...
      noDefaultSession: "No default session key set",
      instancesDetail: "Visible connected clients and nodes.",
      agentsDetail: "Available workspace agent lanes.",
      cronDetail: "Scheduled wakeups and recurring runs.",
    },
    stats: {
      tasks: "Tasks",
      tasksDetail: "{count} active items across the current workspace shell.",
      sessions: "Live sessions",
      sessionsDetail: "{count} active sessions visible from Mission Control.",
      approvals: "Approvals",
      approvalsDetail: "Operator decisions currently waiting.",
      risk: "Scheduled work",
      riskDetail: "{count} cron-backed items currently in play.",
    },
    board: {
      title: "Task board",
      subtitle:
        "Mission Control should feel like a real operating surface, not just a status dashboard.",
      empty: "No tasks in this column yet.",
      priority: {
        low: "Low",
        medium: "Medium",
        high: "High",
      ...
      cards: {
        waitingForLane: "Waiting for a dedicated lane session.",
        workspaceSweep: {
          title: "Morning workspace sweep",
          summary: "Review cron-backed checks and open workrooms. Active schedule items: {count}.",
        },
        routingSuggestion: {
          title: "Review latest intake routing",
        },
      },
    },
    intake: {
      title: "Routing dock",
      subtitle:
        "Choose a lane, shape the request, and create a real routed session without leaving the board.",
      routeLabel: "Route template",
      laneLabel: "Target lane",
      titleLabel: "Working title",
      titlePlaceholder: "Example: Website attribution cleanup",
      requestLabel: "Request",
      requestPlaceholder: "Paste the real operator request or scoped handoff here.",
      previewTitle: "Routing preview",
      previewLane: "Lane: {lane}",
      reset: "Reset",
      submit: "Create routed session",
    },
    actionBar: {
      title: "Route and launch",
      subtitle: "Shape the request, confirm the lane, and start the next scoped session.",
      focusTitle: "Routing focus",
      draftFallbackTitle: "Workspace request",
    ...
    activity: {
      title: "Live activity",
      subtitle: "Recent movement across gateway state, sessions, and lane coverage.",
      gatewayHealthy: "Gateway and Mission Control are connected.",
      gatewayNeedsAttention:
        "Gateway connection needs attention before coordination is trustworthy.",
      laneCoverage: "Lane coverage",
      defaultRoom: "Default room",
      noRecentRoom: "No recent session",
      noRecentActivity: "No recent activity yet.",
      lastTouched: "Last touched {time}",
      attention: "Needs attention",
      live: "Live",
      ready: "Ready",
      liveSessionTitle: "{lane}",
      sessionMeta: "{domain} · {time}",
      idleLaneTitle: "{lane}",
      idleLaneMeta: "No active lane session right now.",
      defaultSessionTitle: "Default session",
      defaultSessionMeta: "Open the main project session when lane routing is not needed.",
      openSessions: "Open sessions",
      suggestedRouteTitle: "Suggested route: {route}",
    },
    workspaceHeader: {
      title: "Workspace command surface",
      subtitle: "Live workspace state, session coverage, and scheduled execution at a glance.",
      liveSessions: "Live sessions {count}",
      instances: "Instances {count}",
      cron: "Cron jobs {count}",
    },
    workspace: {
      title: "Workspace domains",
      subtitle: "Ownership stays editable, but it now sits below the primary operating surface.",
    },
    sessionMap: {
      title: "Lane map",
      subtitle: "Mission Control keeps the live lane and session plumbing visible under the board.",
      coverage: "Matched lanes {matched}/{total}",
      matched: "Matched {count}",
      unmatched: "Unmatched",
      lastUpdated: "Last updated {time}",
      noSession: "No matched session yet",
      open: "Open chat",
      create: "Create lane session",
    },
    registry: {
      owner: "Owner",
    },
    teams: {
      title: "Team model",
      subtitle: "Workspace-level ownership before deeper automation lands.",
      control: "Hermes / Control",
      delivery: "Claude / Delivery",
      review: "Codex / Review",
      operator: "Human Operator",
    },
    teamRooms: {
      title: "Team rooms",
      subtitle: "Reusable operational rooms for each top-level workspace domain.",
      activeSessions: "Active sessions {count}",
      noSessions: "No live session",
      currentSessions: "Current sessions",
      noSessionsDetail: "No matched session is active yet for this room.",
    ...
    routes: {
      ...
      subtitle: "Reusable routing actions still exist, but they now support the tasks-first shell.",
      use: "Use route",
    },
    approvals: {
      title: "Approvals",
      subtitle: "Human review and unblock points that need explicit judgment.",
    },
    context: {
      title: "Context",
      subtitle: "Reference surfaces to keep nearby while routing and intervening.",
    },
    projects: {
      title: "Projects",
      subtitle: "Current workspace domains, progress surfaces, and active related sessions.",
    },
    system: {
      title: "System",
      subtitle: "Coverage, lane bindings, and the current operational footprint.",
      coverage: "Coverage {matched}/{total}",
    },
    defaults: {
      title: "Workspace defaults",
      subtitle: "Current default values exposed by the live Control UI state.",
      sessionKey: "Default session key",
    },
    links: {
      title: "Jump into the current system",
