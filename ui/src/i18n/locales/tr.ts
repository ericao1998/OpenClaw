...
export const tr: TranslationMap = {
  ...
  missionControl: {
    ...
    subtitle: "Workspace home for routing, ownership, and active implementation slices.",
    shell: {
    ...
    intake: {
      title: "Routed intake composer",
      subtitle: "Choose a lane, shape the request, and create a real routed session.",
    ...
    workspace: {
      ...
      subtitle: "The repos and execution lanes Mission Control needs to coordinate.",
    },
    sessionMap: {
      title: "Session map",
      subtitle: "The seeded workspace lanes Mission Control is expected to coordinate.",
    ...
    routes: {
      title: "Intake routing contract",
      subtitle: "How Mission Control should route work across sessions, repos, and Slack.",
      use: "Use route",
    },
    defaults: {
